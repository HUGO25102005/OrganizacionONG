...
CREATE TABLE Usuarios (
    ID_Usuario                   INT                     PRIMARY KEY                 AUTO_INCREMENT     COMMENT 'Identificador único para cada voluntario',
    ...
    Presencial_Virtual              ENUM('Administrador', 
                                         'Coordinador', 
                                         'Voluntario')                      NOT NULL                    COMMENT 'Rol de cada usuario que cumple con una función',
