...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('programas_educativos', function (Blueprint $table) {
            ...
            $table->id();
            $table->foreignId('id_voluntario')->nullable()->constrained('voluntarios')->onDelete('set null')->onUpdate('cascade')->comment('Clave foranea de voluntario');
        ...
        Schema::create('aprobacion_contenidos', function (Blueprint $table) {
            $table->id();
            $table->foreignId('id_programa_educativo')->constrained('programas_educativos')->onDelete('cascade')->onUpdate('cascade')->comment('Clave foranea de programas_educativos');
            $table->foreignId('id_coordinador')->constrained('coordinadores')->onDelete('cascade')->onUpdate('cascade')->comment('Clave foranea de programas_educativos');
            $table->boolean('si_no');
            $table->timestamps();
        });
        Schema::create('aprobacion_presupuestos', function (Blueprint $table) {
            $table->id();
            $table->foreignId('id_presupuesto')->constrained('presupuestos')->onDelete('cascade')->onUpdate('cascade')->comment('Clave foranea de programas_educativos');
            $table->foreignId('id_administrador')->constrained('administradores')->onDelete('cascade')->onUpdate('cascade')->comment('Clave foranea de programas_educativos');
            $table->boolean('si_no');
            $table->timestamps();
        });
        Schema::create('salones_clases', function (Blueprint $table) {
            $table->foreignId('id_programa_educativo')->constrained('programas_educativos')->onDelete('cascade')->onUpdate('cascade')->comment('Clave foranea de programas_educativos');
            $table->foreignId('id_beneficiarios')->constrained('beneficiarios')->onDelete('cascade')->onUpdate('cascade')->comment('Clave foranea de programas_educativos');
            $table->timestamps();
        });
    }
