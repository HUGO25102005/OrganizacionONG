   ...
   <div id="clasesContainer"
       class="bg-[#f6f8ff] w-full max-w-[1450px] h-auto my-[20px] p-[20px] shadow-lg rounded-[30px]">
       ...
       <div class="flex flex-col md:flex-row items-start space-y-2 md:space-y-0 md:space-x-6">
           ...
           <div>
               ...
               <div id="dropdown" class="mt-4">
                   <ul class="space-y-2 text-gray-600">
                       <li onclick="mostrarSoloDetalles('Codeando fácil')"
                       ...
                       <li onclick="mostrarSoloDetalles('Aprendiendo código')"
                           class="flex items-center space-x-3 bg-[#ffecb3] hover:bg-[#ffe082] p-4 rounded-lg cursor-pointer transition duration-200 shadow-md border border-[#ffb300] w-full md:w-56">
           ...
           <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
               ...
               <div
                   ...
                   <p class="text-gray-700 mt-2">Introducción a los conceptos básicos de programación para
                       principiantes.</p>
               ...
               <div
                   ...
                   <p class="text-gray-700 mt-2">Curso avanzado para profundizar en temas complejos de programación.
                   </p>
