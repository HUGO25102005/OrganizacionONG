@foreach ($datos as $beneficiario)
        <tr class="border-b border-gray-300">
            ...
            <td class="py-3 px-4"><div class="items-center h-8 justify-center flex bg-blue-100 rounded-full"><b>{{ $beneficiario->getEstadoDescripcion() }}</b></div></td>
            <td class="py-3 px-4 text-center">
                <div class="inline-flex items-center">
                    @if ($beneficiario->estado == 3)
                        ...
                        <x-button-cancel :messageAlert="'¿Estás seguro de que deseas declinar la solicitud?'" :router="route('coordinador.cancelar')" :itemId="$beneficiario->id" :tituloModal="'Confirmar Eliminación'" />                    
                    @endif
                </div>
            </td>
        </tr>
