<x-app-layout>
    ...
    <div class="bg-[#F6F8FF] w-full max-w-[1450px] h-auto my-[20px] p-[20px] shadow-lg rounded-[30px]">
        <div class="bg-gradient-to-r from-[#2A334B] via-[#46567E] via-[16%] via-[#546797] via-[31%] via-[#5B70A4] via-[47.5%] via-[#546797] via-[63%] via-[#46567E] via-[77.5%] to-[#2A334B] w-full max-w-[1480px] h-[300px] flex justify-center items-center rounded-[15px]">
            <!-- Contenido aquí -->
        
                <!-- Contenido aquí -->
        
            <div class="bg-[#F2F8FF] w-full max-w-[1360px] h-[280px] rounded-[10px] p-[20px] grid grid-cols-1 sm:grid-cols-2 gap-[40px] items-center">
        ...
        <div class="bg-gradient-to-r from-[#2A334B] via-[#46567E] to-[#2A334B] w-full max-w-[1480px] h-[225px] mt-[20px] rounded-[15px] flex justify-center items-center">
            <div class="bg-[#F2F8FF] w-full max-w-[1360px] h-[208px] rounded-[15px]">
                <div class="flex justify-between">
                  ...
                  <div class="flex flex-col space-y-4 mr-[40px] mt-[20px]">
                    <!-- Primer botón -->
                    <a href="#">
                      <div class="bg-[#CCE4FF] w-[600px] h-[70px] rounded-[12px] flex items-center justify-center transition-transform duration-300 hover:scale-105">
