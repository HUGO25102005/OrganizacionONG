<div class="bg-white p-4 rounded-lg shadow-md mb-6">
    <div class="flex flex-wrap items-center justify-between mb-4 space-y-4 md:space-y-0">
        <div class="flex flex-col md:flex-row items-center space-x-6 space-y-4 md:space-y-0 w-full md:w-auto">
            <!-- Filtro de rol -->
            <form action="{{ route('admin.usuarios') }}" method="POST" class="flex flex-col md:flex-row items-center space-x-6 w-full md:w-auto">
                @csrf
                @method('GET')
                ...
                <div class="w-full md:w-auto">
                    <button id="filterButton" type="submit"
                        class="w-full px-4 py-2 bg-blue-400 text-white font-medium rounded-md shadow-sm hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transform transition-transform duration-200 hover:scale-110">
                        Aplicar Filtros
                    </button>
                </div>
            </form>
