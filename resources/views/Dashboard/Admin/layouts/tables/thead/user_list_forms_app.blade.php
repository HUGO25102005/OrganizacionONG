    ...
    @switch($tipo)
        @case('Administrador')
            <x-modal-form :btnTitulo="'Nuevo Administrador'" :tituloModal="'Agrega Nuevo Administrador'" :router="route('admin.store')" :btnDanger="'Cancelar'" :btnSuccess="'Confirmar'">
                <!-- Nombre -->
                <x-input-form-modal :name="'name'" :labelText="'Nombre:'" :type="'text'" :id="'name'" placeholder="Nombre "
                ...
                <x-input-form-modal :name="'fecha_nacimiento'" :labelText="'Fecha de Nacimiento:'" :type="'date'" :id="'fecha_nacimiento'" required
                    :placeholder="'fecha_nacimiento'" :value="old('fecha_nacimiento')">
                    <i class='bx bxs-universal-access'></i>
                </x-input-form-modal>
                ...
                {{-- <!-- Contraseña --> --}}
                <x-input-form-modal :name="'password'" :labelText="'Contraseña:'" :type="'password'" placeholder="Contraseña"
                    :id="'password'" required :value="old('password')">
                    <i class='bx bxs-lock-alt'></i>
                </x-input-form-modal>

                {{-- <!-- Confirmar Contraseña --> --}}
                <x-input-form-modal :name="'password_confirmation'" :labelText="'Confirmar Contraseña:'" placeholder="Confirmar contraseña" :type="'password'"
                ...
                <div class="flex items-center bg-gray-100 rounded-full p-2">
                    ...
                    <select class="flex-1 bg-transparent border-none outline-none text-black placeholder-gray-500 text-sm px-2"
                ...
                <x-input-form-modal :name="'hora_inicio'" :labelText="'Hora Inicio:'" :type="'time'" :id="'hora_inicio'" required
                    :value="old('hora_inicio')" :placeholder="''">
                    <i class='bx bxs-phone-call'></i>
                </x-input-form-modal>
            ...
            --> --}}
                <x-input-form-modal :name="'hora_fin'" :labelText="'Hora Fin:'" :type="'time'" :id="'hora_fin'" required
                    :value="old('hora_fin')" :placeholder="''">
                    <i class='bx bxs-phone-call'></i>
                </x-input-form-modal>
