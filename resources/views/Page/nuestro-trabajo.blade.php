...
<section class="rutinas" id="rutinas">
    ...
    <div class="cards">
        <div class="card">
            <img src="{{asset('images/const1.jpg')}}">
            <div class="info">
                <h3>Valle Paraiso</h3>
        ...
        <div class="card">
            <img src="{{asset('images/const2.jpg')}}">
            <div class="info">
                <h3>Los patos</h3>
        ...
        <div class="card">
            <img src="{{asset('images/const3.jpg')}}">
            <div class="info">
                <h3>Santiago</h3>
...
<section class="sect4">
    <div class="carousel">
        <div class="carousel-slide">
            <img src="{{asset('images/centro1.jpg')}}" alt="Imagen 1">
            <div class="carousel-text">
               
            </div>
        </div>
        <div class="carousel-slide">
            <img src="{{asset('images/centro2.jpg')}}" alt="Imagen 2">
            <div class="carousel-text">
...
<section class="rutinas" id="rutinas">
    ...
    <div class="cards">
        <div class="card">
            <img src="{{asset('images/graduada1.jpg')}}">
            <div class="info">
        ...
        <div class="card">
            <img src="{{asset('images/graduado2.jpg')}}">
            <div class="info">
        ...
        <div class="card">
            <img src="{{asset('images/graduada3.jpg')}}">
            <div class="info">
