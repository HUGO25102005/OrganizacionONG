...
{{-- <div id="coordinatorModal" class="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-50 hidden">
    <div class="bg-white rounded-lg p-6 w-full max-w-lg shadow-xl" style="width: 900px; height: 700px;">
        ...
        <form id="coordinadorForm" action="{{ route('coordinador.store') }}" method="POST">
            @csrf
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="relative mb-4">
                ...
                <input type="text" id="habilidades" placeholder="Habilidades clave"
                    class="pl-4 py-2 bg-[#E6ECF8] rounded-full w-full drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636] text-xs">
            </div>
            <!-- Fecha de nacimiento -->
            <div class="relative mb-4">
            ...
            <div class="relative mb-4">
                ...
                <input type="text" id="idiomas" placeholder="Idiomas"
                    class="pl-4 py-2 bg-[#E6ECF8] rounded-full w-full drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636] text-xs">
            </div>
            <!-- Género -->
            <div class="relative mb-4">
            ...
            <div class="relative mb-4">
                ...
                <input type="text" id="funcion_clave" placeholder="Función clave"
                    class="pl-4 py-2 bg-[#E6ECF8] rounded-full w-full drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636] text-xs">
            </div>
            <!-- Domicilio -->
            <div class="relative mb-4">
            ...
            <div class="relative mb-4">
                ...
                <input type="text" id="area_supervision" placeholder="Área de supervisión"
                    class="pl-4 py-2 bg-[#E6ECF8] rounded-full w-full drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636] text-xs">
            </div>
            <!-- Teléfono -->
            <div class="relative mb-4">
            ...
            <div class="relative mb-4">
                ...
                <input type="text" id="manejo_equipos" placeholder="Capacidad de manejo de equipos"
                    class="pl-4 py-2 bg-[#E6ECF8] rounded-full w-full drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636] text-xs">
            </div>
            <!-- Correo electrónico -->
            <div class="relative mb-4">
            ...
            <div class="relative mb-4">
                ...
                <input type="text" id="conocimiento_herramientas" placeholder="Conocimiento de herramientas"
                    class="pl-4 py-2 bg-[#E6ECF8] rounded-full w-full drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636] text-xs">
            </div>
            <!-- Especialización en cursos -->
            <div class="relative mb-4">
                <i class='bx bx-book-open absolute left-2 top-2.5 text-[#3B3636]'></i>
                <input type="text" id="cursos" placeholder="Especialización en cursos"
                    class="pl-4 py-2 bg-[#E6ECF8] rounded-full w-full drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636] text-xs">
            </div>
            <!-- Disponibilidad de horario -->
            <div class="relative mb-4">
                <i class='bx bx-time-five absolute left-2 top-2.5 text-[#3B3636]'></i>
                <input type="text" id="disponibilidad_horarios" placeholder="Disponibilidad de horario"
                    class="pl-4 py-2 bg-[#E6ECF8] rounded-full w-full drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636] text-xs">
            </div>
            <!-- Experiencia laboral -->
            <div class="relative mb-4">
                <i class='bx bx-history absolute left-2 top-2.5 text-[#3B3636]'></i>
                <input type="text" id="experiencia_laboral" placeholder="Experiencia laboral"
                    class="pl-4 py-2 bg-[#E6ECF8] rounded-full w-full drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636] text-xs">
            </div>
            <!-- Disponibilidad de viajes -->
            <div class="relative mb-4">
                <i class='bx bx-plane absolute left-2 top-2.5 text-[#3B3636]'></i>
                <input type="text" id="disponibilidad_viajes" placeholder="Disponibilidad de viajes"
                    class="pl-4 py-2 bg-[#E6ECF8] rounded-full w-full drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636] text-xs">
            </div>
            <!-- Experiencia en sector educativo -->
            <div class="relative mb-4">
                <i class='bx bx-book-reader absolute left-2 top-2.5 text-[#3B3636]'></i>
                <input type="text" id="experiencia_educativa" placeholder="Experiencia en sector educativo"
                    class="pl-4 py-2 bg-[#E6ECF8] rounded-full w-full drop-shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636] text-xs">
            </div>
        </div>
