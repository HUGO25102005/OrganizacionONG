                    ...
                    <div class="flex transition-transform ease-in-out duration-500"
                        ...
                        <div x-show="tab === 'personal'" x-transition:enter="transition ease-out duration-500"
                            ...
                            <div class="grid grid-cols-2 gap-4 p-4 bg-gray-100 rounded-lg">
                                <div class="mb-4">
                                    <input type="text" value="{{ old('name') }}" id="vol_name" name="name" placeholder="Nombre"
                                        class="w-full form-control py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500">
                                </div>
                                <div class="mb-4">
                                    <input type="text" value="{{ old('apellido_paterno') }}" id="vol_apellido_paterno" name="apellido_paterno" placeholder="Apellido Paterno"
                                        class="w-full form-control py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500">
                                </div>
                                <div class="mb-4">
                                    <input type="text" value="{{ old('apellido_materno') }}" id="vol_apellido_materno" name="apellido_materno" placeholder="Apellido Materno"
                                        class="w-full form-control py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500">
                                </div>
                                <div class="mb-4">
                                    <input type="email" value="{{ old('email') }}" id="vol_email" name="email" placeholder="Correo electrónico"
                                        class="w-full form-control py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="date" value="{{ old('fecha_nacimiento') }}" id="vol_fecha_nacimiento" name="fecha_nacimiento"
                                        class="w-full form-control py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500">
                                </div>
                                
                                <div class="mb-4">
                                    <input type="tel" value="{{ old('telefono') }}" id="vol_telefono" name="telefono" placeholder="Teléfono"
                                        class="w-full form-control py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500">
                                </div>
                                <div class="mb-4">
                                    <input type="text" value="{{ old('direccion') }}" id="vol_direccion" name="direccion" placeholder="Dirección"
                                        class="w-full form-control py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500">
                                </div>
                                <!-- País -->
                                <div class="mb-4">
                                    <input type="text" value="{{ old('pais') }}" id="vol_pais" name="pais" placeholder="País"
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                         maxlength="100">
                                </div>
                                ...
                                <!-- Estado -->
                                <div class="mb-4">
                                    <input type="text" value="{{ old('estado') }}" id="vol_estado" name="estado" placeholder="Estado"
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                         maxlength="100">
                                </div>
                                ...
                                <!-- Municipio -->
                                <div class="mb-4">
                                    <input type="text" value="{{ old('municipio') }}" id="vol_municipio" name="municipio" placeholder="Municipio"
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                         maxlength="100">
                                </div>
                                ...
                                <!-- Código Postal -->
                                <div class="mb-4">
                                    <input type="text" value="{{ old('cp') }}" id="vol_cp" name="cp" placeholder="Código Postal"
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                         minlength="5"  >
                                </div>
                            </div>
                        ...
                        <div x-show="tab === 'tecnicos'" x-transition:enter="transition ease-out duration-500"
                            ...
                            <div class="grid grid-cols-2 gap-4 p-4 bg-gray-100 rounded-lg">
                                <div class="mb-4">
                                    <input type="text" value="{{ old('dias_disponibles') }}" id="vol_dias_dispo" name="dias_disponibles" placeholder="Días disponibles"
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div class="mb-4">
                                    <input type="text" value="{{ old('preferencia_colaboracion') }}" id="vol_preferencia_colabo" name="preferencia_colaboracion"
                                        placeholder="Preferencia de colaboración"
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div class="mb-4">
                                    <input type="text" value="{{ old('experiencia_previa') }}" id="vol_experencia_previa" name="experiencia_previa" placeholder="Experiencia previa"
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div class="mb-4">
                                    <input type="text" value="{{ old('habilidades_conocimientos') }}" id="vol_habilidades" name="habilidades_conocimientos"
                                        placeholder="Habilidades y conocimientos"
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div class="mb-4">
                                    <input type="text" value="{{ old('area_interes') }}" id="vol_area" name="area_interes" placeholder="Área de interés"
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div class="mb-4">
                                    <input type="number" value="{{ old('hrs_dedicadas_semana') }}" id="vol_hrs_dedicadas_semana"  name="hrs_dedicadas_semana"
                                ...
                                <div class="mb-4">
                                    <label for="fecha_inicio" class="block text-gray-700 font-medium mb-2">Fecha de
                                        inicio</label>
                                    <input type="date" value="{{ old('fecha_incio') }}" id="vol_fecha_inicio" name="fecha_inicio"
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                        >
                                </div>
                                <div class="mb-4">
                                    <label for="fecha_termino" class="block text-gray-700 font-medium mb-2">Fecha de
                                        termino</label>
                                    <input type="date" value="{{ old('fecha_termino') }}" id="vol_fecha_termino"  name="fecha_termino"
                                        class="w-full py-2 px-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                        >
                                </div>
