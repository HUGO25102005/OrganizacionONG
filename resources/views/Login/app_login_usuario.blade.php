...
@section('forms')
    ...
    <div class="w-[350px] h-[400px] bg-gray-200 rounded-lg shadow-md p-8">
        <h2 class="text-2xl text-center text-gray-800 mb-2">Bienvenido Usuario</h2>
        ...
        <form class="space-y-6">
            <div class="relative">
                ...
                <input type="text" id="username" name="username" placeholder="Usuario" required class="w-full p-3 pl-10 rounded-lg bg-gray-100 border-none shadow-inner focus:outline-none">
            </div>
