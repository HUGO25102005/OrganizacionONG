...
(function () {
    ...
    function mostrarSoloDetalles(idClase) {
        ...
        const url = document.getElementById("detallesClaseInscrito").getAttribute("data-url");
        console.log(url);
        const dataFetch = {
            id_clase: idClase,
        };
        ...
        fetch(url, {
            ...
            .then((response) => {
                ...
                const { name } = voluntario.trabajador.user;
                ...
                instructorActividad.textContent = `Instructor: ${name}`;
